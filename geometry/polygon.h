...
/** Returns signed polygon area magnitude / 2. Time: O(n). */
template<typename T>
...
// Circle functions
/** Returns whether four points are concyclic. Time: O(1). */
template<typename T>
...
/** Returns whether d lies inside circumcircle of abc. Time: O(1). */
template<typename T>
...
/** Returns whether d lies outside circumcircle of abc. Time: O(1). */
template<typename T>
