...
// query(qm, ql, qr) returns \sum_{ql <= i < qr} Choose(qm,i), where qm <= n
...
// query(qm, ql, qr) returns \sum_{ql <= i < qr} base^i * Choose(qm,i), where qm <= n
template<class T, bool PRECALC_INVERSE = true>
...
// query(qm, ql, qr) returns \sum_{ql <= i < qr} i^j * Choose(qm,i) for all integer 0 <= j <= deg, where qm <= n
template<class T, bool PRECALC_INVERSE = true>
...
// query(qm, ql, qr) returns \sum_{ql <= i < qr} i^j * base^i * Choose(qm,i) for all integer 0 <= j <= deg, where qm <= n
template<class T, bool PRECALC_INVERSE = true>
