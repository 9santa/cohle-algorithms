...
private:
    ...
    void apply_add(int v, int l, int r, ll val) {
        ...
        data[v].max1 += val;
        if (data[v].max2 != -infinity_value<ll>::value) data[v].max2 += val;
        data[v].min1 += val;
        if (data[v].min2 != infinity_value<ll>::value) data[v].min2 += val;
        data[v].lazy_add += val;
    }
    ...
    void apply_min(int v, ll val) {
        ...
        if (data[v].min2 != infinity_value<ll>::value && data[v].min2 > val) { // sync min2 if needed
            data[v].min2 = val;
        }
    }
    ...
    void apply_max(int v, ll val) {
        ...
        if (data[v].max2 != -infinity_value<ll>::value && data[v].max2 < val) { // sync max2 if needed
            data[v].max2 = val;
        }
    }
...
private:
    void build(const vector<ll>& arr, int v, int l, int r) {
        ...
        if (l == r) {
            ...
            data[v].max2 = -infinity_value<ll>::value;
            data[v].min2 = infinity_value<ll>::value;
